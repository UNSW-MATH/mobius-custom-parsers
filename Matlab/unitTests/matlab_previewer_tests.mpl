...
TestExpressions :=
   ...
   ,"tan([1,2,3])"
   ,"[ 1 1 ] - [ 2 2 ; 2 2 ]"
   ,"1+[1 2;3 4]","[1 2;3 4]+t","[-1 1]+[1 2;3 4]","[-1;1]+[1 2;3 4]","[1 2 3]+[1 2;3 4]"
   ,"1-[1 2;3 4]","[1 2;3 4]-t","[-1 1]-[1 2;3 4]","[-1;1]-[1 2;3 4]","[1 2 3]-[1 2;3 4]"
   ,"(sin+tan)([1,2,3])"
   ,"a+bi","a+b*i","3+4*I","3+4i","3+4j","B2i"
   ,"[1,1,2]","[1 sqrt(2), pi]","1,1,1"
   ,"exp(x^2+x)","sin(3*x)","cos(2*x)","cosh(2*x+y)","tanh(3*x+5*y)","coth(a*b+c*d)"
   ,"[sin(3*x),cos(2*x),cosh(2*x+y);tanh(3*x+5*y),coth(a*b+c*d),tan(2*x+d*y)]"
   ,"asin(x*y)","arcsin(3*x)"
   ,"nchoosek(3,2)","nchoosek(n,k)"
   ,"x,y,z"
   ,"1/-2","1*-2"
   ,"factorial(n)","222*2!","(1+a)!","(sin(a))!"
   ...
   ,"1++1","[1 ++2]","[1 + +2]","[1 --3i]'"
   ,"eye(10)","eye(20)"
   ,"[x y z t] + [a;b;c]","[x;y;z;y] + [a;b;c]"
   ,"x=2*y","x+y+z=0"
   ,"x==2*y","x+y+z==0"
   ,"([-2 -8 -8 ; -5 -2 1 ; 8 6 1]')\\[1 0 0]'","([-2 -8 -8 ; -5 -2 1 ; 8 6 1]')\[1 0 0]'"
   ,"sqrt(1+x^2)","sqrt(x^2+1)"
   ];
